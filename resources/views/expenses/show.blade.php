        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                                    ...
                                    <td>
                                        <div class="row text-center">
                                            ...
                                            <div class="col">
                                                ...
                                                <form action="{{route('expenses.show', $record->id) }}" method="GET">
                                                    @csrf
                                            ...
                                            <div class="col">
                                                <form action="{{route('expenses.destroy', $record->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    <h4 class="text-center mt-3">No record to show.</h4>
                    @endif
                </div>
